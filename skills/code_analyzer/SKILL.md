...
- $$GUIDE_FRONT: $$SRC에 대한 guide docs (default: $$SRC_FRONT/docs/guide/INDEX.md) 
- $$GUIDE_BACK: $$SRC에 대한 guide docs (default: $$SRC_BACK/docs/guide/INDEX.md) 
- $$GUIDE_ELECTRON: $$SRC에 대한 guide docs (default: $$SRC_ELECTRON/docs/guide/INDEX.md) 
- $$Domain: 관련 도메인
