...
- Scope별 추가 정보:
  - FRONT: $$SRC_FRONT (필수), $$GUIDE_FRONT (기본: $$SRC_FRONT/docs/guide/INDEX.md)
  - BACK: $$SRC_BACK (필수), $$GUIDE_BACK (기본: $$SRC_BACK/docs/guide/INDEX.md)
  - DESK: $$SRC_ELECTRON (필수), $$GUIDE_ELECTRON (기본: $$SRC_ELECTRON/docs/guide/INDEX.md)
