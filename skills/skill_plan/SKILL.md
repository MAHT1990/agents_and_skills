...
| 5 | plan_screen_designer | 화면 설계 | 주요 화면 구성 및 사용자 흐름(User Flow) 설계 |
...
- Step별 전체 작업 요약
  ...
  - Step 5. 화면 설계 결과 (화면 수, User Flow)
